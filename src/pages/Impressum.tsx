        ...
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
            ...
            <section>
              ...
              <p>
                Kleinunternehmerin nach § 19 UStG:<br />
                Aufgrund der Kleinunternehmerregelung wird gemäß § 19 UStG keine Umsatzsteuer erhoben.
              </p>
            </section>
            ...
            <section>
              ...
              <h3 className="font-heading text-xl text-foreground mb-3 mt-6">
                Haftung für Inhalte
              </h3>
              <p>
