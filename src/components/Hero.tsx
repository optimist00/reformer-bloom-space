  ...
  return (
    ...
    >
      ...
      <div className="container text-center animate-fade-in-up relative z-10 max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.4)]">
        ...
        {/* Subheadline */}
        <p className="text-base md:text-lg text-white/80 mb-10 drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
